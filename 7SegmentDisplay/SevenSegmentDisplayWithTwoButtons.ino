...
private:
    ...
    bool isRandomMode = false; //track the mode whether random or normal
...
public:
    ...
    void startGame(){
      ...
      long duration = 10000;
      int delayPeriod = random(10,100);
      int delayIncrement = random(10,50);

      while(millis() - startTime < duration){
        if(isRandomMode){
          currentValue = random(0,10);
        }
        else{
    ...
    void checkButton(){
      ...
      if(digitalRead(secButton) == LOW && !isRunning){
